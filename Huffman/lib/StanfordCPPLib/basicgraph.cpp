 ...
 */
Vertex::Vertex(std::string name) : name(name), edges(arcs), weight(cost) {
    this->resetData();
}
...
bool BasicGraph::containsArc(std::string v1, std::string v2) const {
    return this->getArc(v1, v2) != NULL;
}
...
bool BasicGraph::containsEdge(std::string v1, std::string v2) const {
    return this->containsArc(v1, v2);
}
...
bool BasicGraph::containsNode(std::string name) const {
...
bool BasicGraph::containsVertex(std::string name) const {
...
Edge* BasicGraph::getArc(std::string v1, std::string v2) const {
...
Edge* BasicGraph::getEdge(std::string v1, std::string v2) const {
    return this->getArc(v1, v2);
}
...
bool BasicGraph::isNeighbor(std::string v1, std::string v2) const {
...
Edge* BasicGraph::addEdge(std::string v1, std::string v2, double cost, bool directed) {
...
Vertex* BasicGraph::addVertex(std::string name) {
...
const Set<Edge*>& BasicGraph::getEdgeSet(std::string v) const {
    return this->getArcSet(v);
}

Vertex* BasicGraph::getVertex(std::string name) const {
...
void BasicGraph::removeEdge(std::string v1, std::string v2, bool directed) {
...
void BasicGraph::removeVertex(std::string name) {
