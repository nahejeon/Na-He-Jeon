...
DawgLexicon::DawgLexicon(std::string filename) {
    edges = start = NULL;
    numEdges = numDawgWords = 0;
...
void DawgLexicon::add(std::string word) {
 ...
 */
void DawgLexicon::addWordsFromFile(std::string filename) {
...
bool DawgLexicon::contains(std::string word) const {
    toLowerCaseInPlace(word);
...
bool DawgLexicon::containsPrefix(std::string prefix) const {
 ...
 */
void DawgLexicon::readBinaryFile(std::string filename) {
